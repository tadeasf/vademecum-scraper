...
export class VademecumScraper extends BaseScraper {
  constructor(options = {}) {
    ...
    this.options.startUrl =
      this.options.startUrl ||
      'https://vademecum.nacr.cz/vademecum/permalink?xid=ff8fc441b4737cb36aebbb653842bb74&scan=592712bc-015f-4a37-a6f2-86c5bb9227dc';
  }
  ...
  async scrapePages(totalPages = 401) {
    try {
      await this.init();
